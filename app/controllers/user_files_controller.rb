class UserFilesController < ApplicationController
  ...
  def create
    ...
    @user_file.user_file = user_file_params[:orig]
  ...
  private
    ...
    def set_user_file
      @user_file = current_user.user_files.find_by!(id: params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def user_file_params
      params.require(:user_file).permit(:user_id, :name, :content, :orig)
    end
end
